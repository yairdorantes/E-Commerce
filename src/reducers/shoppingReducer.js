...
// console.log(user);
// helpHttp()
//   .get(`${vars.mySite}/cart/${user.user.id}`)
//   .then((res) => {
//     console.log(res);
//     try {
...
//   helpHttp().post(`${vars.mySite}/updateCart/${user.user.id}`, { body: data });
// };

// export default function cartReducer(state = initialState, action) {
//   switch (action.type) {
//     case ADD_TO_CART: {
//       delete state.cart[0].product_details;
//       const mytesting = JSON.stringify(state.cart[0]);
